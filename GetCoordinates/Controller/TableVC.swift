...
class TableVC: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        locations = tab.coreLocations //updating locations array for display, assigned in first tab
        tableView.reloadData() //reloading to update display
    }
...
extension TableVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) { //swipe to delete cell and saved location from table and core data
